...
contract StableCoin is SID {
    ...
    function depositCollateralBuffer() external payable {
        ...
        uinr256 mintDepositorCoinAmount = addedSurplusEth * oracle.getPrice() * usdInDCPrice;
    ...
    function _getSurplusOrDeficitInContractInUsd() private view returns (int256) {
        ...
        int256 surplusInContract = int256(ethContractBalanceInUsd) - int256(totalSCBalanceInUsd);
